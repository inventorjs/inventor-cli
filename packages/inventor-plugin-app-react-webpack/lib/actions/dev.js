...
export default class DevAction extends Action {
    ...
    logServerInfo({ localAddress, staticPath, historyApiFallback }) {
        this.log.clear();
        this.log.raw([
    ...
    async run(_, options) {
        ...
        await devServer.startCallback(() => this.logServerInfo({ localAddress, staticPath, historyApiFallback }));
    }
}
